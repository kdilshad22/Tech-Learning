        ...
        <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
                ...
                <div className='space-y-4 max-w-[300px] '>
                    <h1 className='text-2xl font-bold'>Tech Learning</h1>
                    <p className='text-dark2'>TL is a platform dedicated to empowering 
                       aspiring developers.
                       from beginner tutorials to advanced
                       programming concepts, we
                       provide a comprihensive learning experince
                       designed to help you
                       master coding skills, build projects, and
                ...
                <div className='space-y-4 max-w-[300px]'>
                    ...
                    <div className='flex space-x-6 py-3'>
                        <a href="#"><FaWhatsapp className='cursor-pointer hover:text-primary hover:scale-105 duration-200'/></a>
                        <a href="#"><FaInstagram className='cursor-pointer hover:text-primary hover:scale-105 duration-200'/></a>
                        <a href="#"><FaYoutube className='cursor-pointer hover:text-primary hover:scale-105 duration-200'/></a>
                        <a href="#"><TbWorldWww className='cursor-pointer hover:text-primary hover:scale-105 duration-200'/></a>
                    </div>
                </div>
            </div>
        </div>
